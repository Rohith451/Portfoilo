...
import { SiHibernate, SiMongodb, SiCss3 } from "react-icons/si";
  ...
  return (
    <div className="border-b border-neutral-800 pb-8">
      ...
      className="flex flex-wrap items-center justify-center gap-4">
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
          <TbBrandNextjs className='text-7xl text-white text-cyan-500'/>
        </motion.div>
        <motion.div
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
          <SiHibernate className="text-7xl text-amber-600" />
        </motion.div>
        <motion.div
